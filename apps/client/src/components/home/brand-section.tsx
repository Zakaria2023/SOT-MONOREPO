    ...
    <section className="w-full bg-white py-24">
      <div className="mx-auto max-w-6xl px-8">
        <header className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="font-heading mt-3 text-4xl leading-tight font-extrabold text-ink">
            Trusted names, one platform.
          </h2>
          <p className="font-grotesk mt-4 text-lg leading-relaxed text-[#62656B]">
            We source, stage and support hardware from the industry&apos;s
            leading manufacturers — unified under a single deployment.
          </p>
        </header>
