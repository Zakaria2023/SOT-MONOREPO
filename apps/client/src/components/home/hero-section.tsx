...
export const HeroSection = () => (
  <section className="relative min-h-[600px] w-full overflow-hidden border-b border-[#1A1A22] bg-[#08080C] shadow-[0_60px_120px_-40px_rgba(0,0,0,0.65)]">
    ...
    <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-12 px-6 py-24 lg:grid-cols-5 lg:gap-16 lg:px-8">
      ...
      <div className="relative mx-auto aspect-square w-full max-w-md lg:hidden">
        <SplineScene
          scene="https://prod.spline.design/kZDDjO5HuC9GJUM2/scene.splinecode"
          className="h-full w-full"
        />
