...
import { deleteVendor } from "@/app/(dashboard)/vendors/action";
...
export const VendorRowActions = ({ uuid, name }: VendorRowActionsProps) => {
  ...
  const handleConfirmDelete = () => {
    startTransition(async () => {
      const result = await deleteVendor(uuid);
